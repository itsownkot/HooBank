      ...
      >
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1
           ...
           text-white ss:leading-[100px] leading-[72px]"
          >
        ...
        <h1
          className="font-poppins font-semibold ss:text-[68px] text-[52px]
           text-white ss:leading-[100px] leading-[72px] w-full"
        >
          Paymant method.
        </h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Our team of experts uses a methodology of identify the credit cards
